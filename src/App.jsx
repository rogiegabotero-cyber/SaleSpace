...
import ClientView, { ClientDashboard } from './ClientView'
...
function Dashboard() {
  ...
  return <>
    ...
    </div> : <div className="dashboard-overview-wrap"><ClientDashboard people={people} /></div>}
